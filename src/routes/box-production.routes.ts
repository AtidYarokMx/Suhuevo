...
class BoxProductionRoutes extends ServerRouter {
  ...
  config(): void {
    ...
    this.router.get('/egg-type-summary', adminMiddleware, this.controller.getEggTypeSummaryFromBoxes as RequestHandler);
    ...
    this.router.post('/sync', adminMiddleware, this.controller.synchronize as RequestHandler)
  }
}
