...
class UserRoutes extends ServerRouter {
  ...
  config(): void {
    ...
    this.router.get('/users', authenticateUser as RequestHandler, userController.getUsers as RequestHandler)
    ...
    this.router.patch('/updateUser', authenticateUser as RequestHandler, userController.updateUser as RequestHandler)
  }
}
